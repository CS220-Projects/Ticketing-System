    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('franchiseID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Restaurant_Staff', to='ticketing_system.franchise')),
                ('restaurantID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Restaurant_Staff', to='ticketing_system.restaurant_location')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='ManagerID',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Restaurant_Manager', to='ticketing_system.staff'),
        ),
        migrations.AddField(
            model_name='restaurant_location',
            name='franchiseID',
